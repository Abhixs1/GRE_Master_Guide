...
## Passage 31 — Behavioral Economics

> Nudges — small changes in how choices are presented that steer people toward better decisions without coercion — have been embraced as a gentle alternative to regulation. Their appeal is real, and so is a difficulty their champions understate. A nudge works by exploiting the very biases that make people predictable, which means the same technique that enrolls someone in a pension can, in other hands, enroll them in a scam. The method is neutral about ends; it borrows its ethics entirely from the nudger's intentions. To celebrate nudging as such is to praise a tool while ignoring the hand that wields it, and tools, unlike principles, do not choose their masters.
...
> Modern readers often approach Greek tragedy expecting psychological depth — characters whose inner conflicts drive the action. The plays frequently disappoint this expectation, and the disappointment is instructive. Tragic figures are defined less by interior states than by their position in a web of obligation, pollution, and fate; what looks like a shallow characterization is a different theory of what a person is. To fault Sophocles for failing to novelize is to demand that he share our assumptions about the self. The plays are not primitive attempts at psychology but articulate expressions of a world in which the self is constituted by its relations rather than its depths.
...
## Passage 33 — Climate Science

> Attribution science — the effort to say how much a given heat wave or flood owes to human-caused warming — has advanced rapidly, but its findings are easily misread. To report that warming made an event "three times more likely" is not to say the event would not have happened otherwise; rare events occur in stable climates too. Nor is it to license the opposite error, the claim that no single event can ever be attributed. Probabilities shift without any event becoming certain or impossible, and the honest statement lies between the headlines that overclaim and the skeptics who deny that attribution means anything. The science is careful; its translation into public speech usually is not.
...
## Passage 34 — Philosophy of Science

> The demand that scientific theories be simple has an honorable pedigree and a shaky justification. Simplicity is prized as a guide to truth, yet why the world should oblige our taste for economy is far from clear. Defenders offer several answers — that simpler theories are easier to test, that they postulate fewer entities to go wrong, that nature has proved cooperative in the past — but each defends a practical virtue rather than a metaphysical guarantee. Simplicity may be a good bet without being a law; we prefer economical theories because they have served us, not because we have shown the universe is parsimonious. The preference is warranted; the cosmic promise is not.
...
## Passage 35 — Demography

> Alarm over falling birth rates has revived a Malthusian logic in reverse: where once too many people threatened ruin, now too few are said to. Both panics share a flaw — they treat a demographic trend as destiny and extrapolate it without limit. Fertility has fallen, but it has also risen unexpectedly in places written off as terminal, and the behaviors driving it — when to marry, whether to have a third child — respond to policy, culture, and economics in ways no straight-line projection captures. To forecast a future by ruler is to ignore the very responsiveness that makes populations human. The trend is real; its continuation is an assumption, not a fact.
...
## Passage 36 — History of Mathematics

> The story that non-Euclidean geometry was born from pure imagination, defying common sense to invent impossible spaces, flatters mathematicians but distorts the record. Its creators did not set out to overthrow Euclid; they tried for centuries to prove his troublesome parallel postulate from the others and, failing, gradually realized that its denial led not to contradiction but to a coherent alternative. The revolution grew from a conservative effort to shore up the old system, not from a romantic leap beyond it. This is the usual shape of conceptual change: the new arrives while the old is being defended, and the defenders are the last to notice they have become revolutionaries.
...
## Passage 37 — Media Studies

> The complaint that social media has destroyed our attention rests on a nostalgia that the historical record does not support. Every information technology, from the printed book to the newspaper to the telephone, was greeted with the same lament: that it fragmented the mind and displaced deeper engagement. The persistence of the complaint across centuries should make us suspicious of its latest version. This is not to deny that the new platforms shape attention — they surely do — but to insist that the shaping be studied rather than mourned, and that "distraction" be measured against a past that was never as contemplative as the mourners imagine.
...
## Passage 38 — Philosophy of History

> The idea that history has a direction — that events tend toward freedom, or reason, or catastrophe — exerts a pull no amount of refutation dispels. Each generation rewrites the arrow to point at its own hopes or fears. The impulse is understandable, for a story needs a shape, and a shapeless past is hard to bear. Yet the direction we find is usually the one we bring: we select the events that fit the trajectory and demote those that do not. This does not prove that history is random, only that the patterns we perceive are as much artifacts of our narration as features of the past. The arrow is drawn, not found.
...
## Passage 39 — Biochemistry

> The metaphor of the enzyme as a lock awaiting its key, rigid and precisely shaped, dominated biochemistry for a century and quietly misled it. Enzymes are not rigid; they flex, and much of their catalytic power comes from motion — from a choreography of shifting conformations that the static image cannot represent. The lock-and-key picture captured specificity, which is real, while hiding dynamics, which are essential. Replacing it has been slow, not because the evidence is weak but because the old metaphor is so intuitive that it survives its own disproof, shaping the questions researchers think to ask long after they have ceased to believe it literally.
...
## Passage 40 — Urban Studies

> The dream of the self-sufficient neighborhood — everything one needs within a short walk — has become the reigning ideal of progressive planning. Its appeal is obvious and its limits less discussed. A neighborhood that supplies all needs can also enclose, turning proximity into parochialism and sparing residents the frictional encounters with difference that cities exist to provide. The genius of urban life was never mere convenience but the collision of unlike people forced into shared space; a district engineered for seamless local sufficiency may deliver comfort at the cost of the very cosmopolitanism it was meant to serve. What looks like the perfection of the city may be its domestication.
...
← Back to [Questions 301–400 index](README.md) · [Start over at 1–100](questions-1-100.md)
